...
var properties = [];
var readFileContents = fs.readFileSync(__dirname+'/1216zpid.csv');
...
//				    	output.histZest = zestFullHistory[index].y;
						console.log(zpid+'='+zestFullHistory[index].y);
				    	fs.appendFileSync(__dirname+'/output.csv', '\015'+zpid+','+zestFullHistory[index].y+',');
